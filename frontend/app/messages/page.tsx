...
export default function MessagesPage() {
  ...
  return (
    <main className="bg-neutral-900 min-h-screen flex flex-col text-neutral-100">
      {/* Main Header */}
      <section className="bg-gradient-to-r from-[#FFCC66] to-[#FF7E5F] py-4 text-center shadow-md">
      ...
      <section className="bg-neutral-950 py-4 px-4 flex items-center justify-between shadow-lg border-b border-neutral-800">
        ...
        <div>
          <Link
            href="/hire-handyman"
            className="flex items-center gap-2 rounded-lg bg-gradient-to-r from-[#FFCC66] to-[#FF7E5F] px-5 py-2 text-white font-medium shadow-[0_0_10px_rgba(255,204,102,0.6),0_0_20px_rgba(255,126,95,0.5)] transition-transform duration-300 hover:scale-105 active:scale-95 cursor-pointer"
          >
            Hire Me
          </Link>
        </div>
            ...
            <div
              className={`max-w-xs px-4 py-2 rounded-xl break-words ${
                msg.sender === "client"
                  ...
                  : "bg-gradient-to-r from-[#FFCC66] to-[#FF7E5F] text-neutral-900 font-medium rounded-br-none"
              }`}
            >
              {msg.text}
            </div>
