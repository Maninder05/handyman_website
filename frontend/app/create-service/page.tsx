        ...
        <div className="w-full max-w-4xl bg-white rounded-xl shadow-lg p-10 space-y-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <label className="flex-1 flex justify-between items-center px-4 py-3 border border-gray-300 rounded-lg  text-neutral-500 bg-neutral-50 cursor-pointer hover:bg-gray-100 transition">
