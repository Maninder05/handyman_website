      ...
      <section className="bg-neutral-200 flex flex-col items-center pt-32 pb-16 px-4 relative">
        ...
        <div className="flex flex-col items-center mb-10">
          <div className="flex items-center gap-2 mb-1">
            <span className="text-orange-500 font-bold text-2xl">5.0</span>
        ...
        {/* Featured Review */}
        {featured && (
          <div className="w-full max-w-4xl bg-white px-6 py-6 rounded-2xl shadow-xl border-l-4 border-cyan-500 mb-12">
